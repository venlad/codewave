      ...
      <div className="w-100">
        ...
        <div class="logo">
          ...
          >
            <img
              width="140px"
              data-src="https://res.cloudinary.com/image/upload/v1586590814/codewave-website/codewave-website-logo.png"
              class="lazyload"
            />
          </a>
        </div>
          ...
          <div className="nav__container">
            <div className="logo--mobile logo--mobile--white">
              <a href="/" data-section="0" className=" is-current ">
                <picture>
                  <img
                    data-src="https://res.cloudinary.com/codewave-technologies/image/upload/c_scale,w_142/v1566712787/codewave-logo-2x_tl2pvw.png"
                    className="lazyload"
                    width="100%"
                  />{" "}
                </picture>
            ...
            <div className="nav__primary right_nav_animation">
              <ul id="test">
                <li>
                  <a
                    href="./services"
            ...
            <div className="nav__secondary nav__secondary-MR nav-animation ">
              <h4 className="title--title6 title--title6-header">
                Top market needs
              </h4>
              <ul>
                <li>
                ...
                <li>
                  <a
                    href="./services/customer-journey-redesign-cx-improvement"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                ...
                <li>
                  <a
                    href="./services/data-strategy-analytics-and-predictive-intelligence"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                    {" "}
                ...
                <li>
                  <a
                    href="./services/cloud-web-mobility"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                ...
                <li>
                  <a
                    href="./services/iot-sensing-tech-and-edge-tech"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                    IoT & Edge AI.
                ...
                <li>
                  <a
                    href="./services/blockchain-implementation"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                    Blockchain.
            ...
            <div className="nav__secondary nav-animation">
              <h4
                className="title--title6 title--title6-header"
              ...
              <ul>
                ...
                <li>
                  <a
                    href="https://casestudies.codewave.com/category/more/"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                    More..
            ...
            <div className="nav__secondary nav-animation">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="./growing-as-a-leader-at-codewave"
                    data-cursor-type="medium"
                    data-cursor-text=""
                  >
                    Growing as a leader.
                ...
                <li>
                  ...
                  >
                    <img
                      data-src="https://res.cloudinary.com/image/upload/c_scale,w_30/v1579333663/medium_geo6zf.png"
                      style={{ float: "left" }}
                      data-cursor-type="medium"
                      data-cursor-text=""
                      className="lazyload"
                  ...
                  >
                    <img
                      data-src="https://res.cloudinary.com/image/upload/c_scale,w_30/v1579333662/linkedin_qyquet.png"
                      data-cursor-type="medium"
                      data-cursor-text=""
                      style={{ float: "left" }}
                      className="lazyload"
